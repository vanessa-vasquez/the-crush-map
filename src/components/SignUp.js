            ...
            <Row>
                <Col md={12} className="text-center">
                    <Alert id="warning" key="warning" variant="warning">
                        For security reasons, please use a secure password that is not affiliated with your Columbia account.
                    </Alert>
                </Col>
            </Row>
            <Row>
                ...
                <Col xs={12} md={6} className="text-center">
                    ...
                    <form id="sign-up-form" onSubmit={addUser}>
                        ...
                        <span>Already have an account? <NavLink to="/login">Login here!</NavLink></span> <br />
