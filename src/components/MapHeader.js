...
export default function MapHeader() {
  ...
  const popoverLeft = (
    <Popover id="popover-positioned-left" title="Information">
      &quotthe crush map.&quot is a graph visualization meant to illustrate the complicated network
      of student crushes at Columbia University. <br /> Start by adding a crush to the map.
      <strong> Don&apost worry! </strong> Your crush will not be able to see that you liked them nor
      can you see who specifically has liked you. That is unless there&aposs a match ;). <br /> What
        ...
        <Col md={6}>
          <div className="logo-container">
            ...
            <div>
              ...
              <span className="desc d-none d-sm-none d-md-block">
