...
export default function MapHeader() {
  ...
  const popoverLeft = (
    <Popover id="popover-positioned-left" title="Information">
      ...
      <strong> Don't worry! </strong> Your crush will not be able to see that you liked them nor can
      you see who specifically has liked you. That is unless there's a match ;). <br /> What you are
      able to see are any anonymous admirers that you and other people may have.
    </Popover>
  );
