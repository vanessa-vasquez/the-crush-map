      ...
      <>
        ...
        <Container>
          ...
          <Row>
            ...
            <Col md={10}>
              <InsertBar cy={cy} crushUni={crushUni} userUni={currentUserUni} setCrushUni={setCrushUni} crushes={crushes} setCrushes={setCrushes} />
            </Col>
          </Row>
          <Row>
            <Col md={2}>
              <div className="d-md-none">
                ...
                setOpen(!open)
                toggleCrushes(!open)
                }} id="toggle-crushes-btn" aria-controls="collapse-crushes" aria-expanded={open}>
              ...
              <div className="d-block d-md-none">
                <Collapse in={open}>
                  <div id="collapse-crushes">
                    <CrushList dbRef={dbRef} cy={cy} crushes={crushes} setCrushes={setCrushes} userUni={currentUserUni}/>
                  </div>
                </Collapse>
              </div>    
            ...
            <Col md={8}>
              <Visualization crushes={crushes} data={data} cy={cy} setCy={setCy} userUni={currentUserUni}/>
            </Col>
            <Col md={2}>
